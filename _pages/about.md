...
I am a Senior Research Scientist at [Fujitsu Research India](https://global.fujitsu/en-apac/local/technology/research), where I am a member of the Security Sciences Lab (SSL) working in the domain of <span style="color: DarkBlue;">privacy auditing and safe alignment of large scale generative models</span>. Previously, I worked as Ph.D sciences intern at [Microsoft India](https://www.microsoft.com/en-us/research/lab/microsoft-research-india/) broadly working in the area of <span style="color: DarkBlue;">LLM personalization</span>. I also served as Ph.D research intern at [Adobe Research, Bangalore](https://research.adobe.com/careers/bangalore/), where I worked on <span style="color: DarkBlue;">data attribution for vision language models</span>. Prior to this, I spent a brief period as a Research Associate at [Oneirix Labs](https://www.oneirix.com/), where I contributed towards development of algorithms grounded on *computational statistics*, with a particular emphasis on their applications in Medical AI. During my undergraduate studies, I also worked as a research intern at *Laboratory for Electro-Optics Systems (LEOS)* of [Indian Space Research Organization (ISRO), Bangalore](https://www.isro.gov.in/LEOS.html) in the domain on integrated devices, systems and communications.
